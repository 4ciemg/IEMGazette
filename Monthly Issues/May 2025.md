...
***
***
## Moondrop Psyche Review
*21/05/2025*

I missed this one, that's on me.
>![](https://i.postimg.cc/RFyRmTMT/Moondrop-Psyche-Review-1.png)
>First ever third party Psyche graphs exclusively for /iemg/. Impressions and comparisons later once I get off work. Tips: JVC Spiral Dots++/Source: Topping DX9 4.4mm
>Captcha: VGPAG
>>![](https://i.postimg.cc/vHWzR9CW/Moondrop-Psyche-Review-2.jpg){width=500}
>>Great:
>>\>Faceplate, it looks amazing when it catches the light in the right way. Hope it doesn't fall off.
>>Good:
>>\>Channel matching is decent for a multi driver pos.
>>\>Comes with a USB C dongle (Moondrop Echo-B).
>>\>Cable uses small plastic connector instead of long ass metal ones.
>>Bad:
>>\>Fat hog shell, this is one obese bitch. The size slightly bothers me, it's not as bad as the Z1R but that I'm bringing it up should tell you something.
>>\>Nozzle has no lip.
>>\>Build quality - hollow resin is less durable and uglier than solid resin.
>>\>No modular cable? Why? Variations had a modular cable.
>>\>Cable is stiff as fuck and wants to twist and bend. This might get better with time.
>>
>>Sound is okay but the tuning isn't anything special. It's shouty and vocals are missing body, but the upper mids and treble are mostly correct apart from the excess 4K energy. Bass is present at about the right level, no complaints there. There's one treble murder spike at 11.5K, that may or may not be just my ears. Subjectively I found it really easy to EQ, just fix the mid suckout and you're 90% there. I usually have to fuck around with treble filters for a while before I'm happy but in this case it took all of 5 minutes.
>>I don't really believe in techs but I do prefer planars to ESTs and other meme treble drivers. ESTs are overly dull, BAs are plasticky. Good planars can sound close to my favorite single DDs. These ones are quite nice, they don't have the zing even without EQ.
>>At the current price I wouldn't recommend psyches to anyone, but it is one of the few anime pos on the market. Anime origin never.
>>EQ masturbatorium:
>>Filter 1: ON PK Fc 20 Hz Gain 2 dB Q 1
>>Filter 2: ON PK Fc 500 Hz Gain 3 dB Q 0.5
>>Filter 3: ON PK Fc 4500 Hz Gain -4 dB Q 1.5
>>
>>Personal treble filters:
>>Filter 4: ON PK Fc 5900 Hz Gain -4 dB Q 6
>>Filter 5: ON PK Fc 7000 Hz Gain 2 dB Q 2
>>Filter 6: ON PK Fc 11450 Hz Gain -5 dB Q 6

>![](https://i.postimg.cc/Pfvy404V/Moondrop-Psyche-Review-3.jpg){width=500}
>It's fat as shit
